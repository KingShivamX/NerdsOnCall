      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12 sm:mb-16 lg:mb-20">
          ...
          <div className="text-base sm:text-lg text-slate-600 w-full max-w-3xl mx-auto leading-relaxed text-center">
            Connect with expert tutors instantly for doubt resolution through
            live video calls. Follow these simple steps to get started.
          </div>
        </div>
            ...
            <div className="order-2 lg:order-1">
              <div className="text-center lg:text-left mb-10 sm:mb-12 lg:mb-16">
                ...
                <p className="text-sm sm:text-base text-black font-bold max-w-xl mx-auto lg:mx-0 bg-white px-4 py-3 border-4 border-black shadow-[4px_4px_0px_0px_black]">
                  Get instant help with your doubts through live video sessions
                  with expert tutors
                </p>
              </div>
            </div>
        ...
        <div className="mb-16 sm:mb-20 lg:mb-24">
          <div className="text-center mb-10 sm:mb-12 lg:mb-16">
            ...
            <div className="text-sm sm:text-base text-slate-600 max-w-xl mx-auto text-center">
              Help students solve their doubts and earn through teaching
            </div>
          </div>
        ...
        <div className="bg-white border border-slate-200 p-6 sm:p-8 lg:p-10 rounded-2xl text-center shadow-lg max-w-4xl mx-auto">
          ...
          <div className="text-base sm:text-lg text-slate-600 mb-6 sm:mb-8 max-w-2xl mx-auto leading-relaxed text-center">
            Start solving your doubts instantly with live video calls and expert tutors available 24/7.
          </div>
