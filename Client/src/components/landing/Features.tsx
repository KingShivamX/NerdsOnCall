    ...
    <section className="py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12 sm:mb-16 lg:mb-20">
          ...
          <div className="text-base sm:text-lg text-slate-600 max-w-3xl mx-auto leading-relaxed text-center">
        ...
        <div className="text-center">
          <div className="bg-white rounded-xl sm:rounded-2xl p-6 sm:p-8 lg:p-10 border border-slate-200 shadow-lg max-w-4xl mx-auto">
            ...
            <div className="text-slate-600 mb-6 sm:mb-8 lg:mb-10 max-w-2xl mx-auto text-sm sm:text-base lg:text-lg leading-relaxed text-center">
