                            ...
                            {tokenInfo ? (
                                <div>
                                    ...
                                    {tokenInfo.exists && (
                                        <>
                                            {tokenInfo.invalid ? (
                                                <p><strong>Status:</strong> ❌ Invalid ({tokenInfo.error})</p>
                                            ) : (
                                                <>
                                                    <p><strong>Status:</strong> {tokenInfo.expired ? '❌ Expired' : '✅ Valid'}</p>
                                                    <p><strong>User ID:</strong> {tokenInfo.payload?.userId}</p>
                                                    <p><strong>Role:</strong> {tokenInfo.payload?.role}</p>
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <div className="bg-gray-100 p-4 rounded text-sm font-mono">
                                ...
                                <p className="break-all">{localStorage.getItem("token") || "None"}</p>
                                <br />
                                <p><strong>document.cookie:</strong></p>
                                <p className="break-all">{document.cookie || "None"}</p>
                            </div>
                        </CardContent>
                    </Card>
                </div>
