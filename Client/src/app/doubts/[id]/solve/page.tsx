...
export default function SolveDoubtPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      formData.append("solutionDescription", solutionData.solutionDescription);
      ...
      toast.error(error.response?.data || "Failed to submit solution");
    } finally {
      setSubmitting(false);
    }
  };
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <Card>
              <CardContent className="p-12 text-center">
                ...
                <p className="mt-4 text-slate-600">Loading doubt details...</p>
              </CardContent>
            </Card>
          </div>
        </div>
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <Card>
              <CardContent className="p-12 text-center">
                ...
                <p className="text-slate-600 mb-4">
                  The doubt you're looking for doesn't exist or you don't have
            ...
            <Card className="bg-white shadow-2xl border-0 rounded-3xl overflow-hidden">
              ...
              <CardContent className="p-6 space-y-4">
                ...
                <div className="border-t pt-4">
                  <h4 className="font-medium text-slate-700 mb-2">Student:</h4>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      value={solutionData.solutionDescription}
                      onChange={(e) =>
                        handleInputChange("solutionDescription", e.target.value)
                      }
                    ...
                    <div className="flex justify-between items-center mt-2">
                      <p className="text-xs text-slate-500">
                        {solutionData.solutionDescription.length}/5000
                        characters
                      </p>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500 mt-2 flex items-start gap-2">
                      ...
                      Record yourself explaining the solution step by step. This
                  ...
                  <div className="flex justify-end space-x-4 pt-6">
                    ...
                    <Button
                      type="submit"
                      disabled={
                        submitting || !solutionData.solutionDescription.trim()
                      }
