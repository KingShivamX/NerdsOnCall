        ...
        <div className="bg-black border-b-4 border-black text-white">
          <div className="container mx-auto px-4 py-12">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <h1 className="text-4xl md:text-5xl font-black mb-6 uppercase tracking-wide text-white">
                Ask a Question
              </h1>
              <p className="text-xl text-white font-bold max-w-2xl mx-auto uppercase tracking-wide">
                Get instant help from our community of expert tutors and fellow
                students
              </p>
            </div>
          </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-sm text-gray-600 flex items-start gap-2">
                    ...
                    Add images to help tutors understand your question better.
                  </p>
                </div>
