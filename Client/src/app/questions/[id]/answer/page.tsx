  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (error.response?.status === 401) {
        ...
        toast.error("You do not have permission to submit solutions.", {
          id: loadingToast,
        });
          ...
          <div className="container mx-auto px-4 py-12">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-xl text-green-100 max-w-2xl mx-auto">
                Help other students by providing a detailed solution with video
                explanation
              </p>
            </div>
          </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
              <div className="p-6 border-b border-gray-100">
                ...
                <p className="text-gray-600 mt-1">
                  Provide a comprehensive solution to help the student
                </p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="p-6 space-y-8">
                <div className="space-y-3">
                  ...
                  <p className="text-sm text-gray-600 flex items-start gap-2">
                    ...
                    Provide a clear, step-by-step explanation that helps the
