            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-slate-600">
                  Track your questions from explore section and tutor requests
                </p>
              </div>
                              ...
                              {doubt.attachments
                                ...
                                .map((attachment, index) => (
                                  <div key={index} className="text-xs">
                                    ...
                                    >
                                      File {index + 1}:{" "}
                                      {attachment.length > 40
                                        ? `${attachment.substring(0, 40)}...`
                                        : attachment}
                                    </a>
                                  </div>
                                ))}
                              {doubt.attachments.length > 2 && (
                                <p className="text-xs text-gray-500">
                                  +{doubt.attachments.length - 2} more files
                                </p>
                              )}
                            </div>
                          </div>
                              ...
                              <div className="flex items-center space-x-2 mb-2">
                                ...
                                {doubt.acceptedTutor && (
                                  <span className="text-xs text-green-600">
                                    by {doubt.acceptedTutor.firstName}{" "}
                                    {doubt.acceptedTutor.lastName}
                                  </span>
                                )}
                              </div>
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                          ...
                          question.imageUrls.length > 0 && (
                            <div className="mb-4">
                              <div className="space-y-1">
                                ...
                                {question.imageUrls.length > 2 && (
                                  <p className="text-xs text-gray-500">
                                    +{question.imageUrls.length - 2} more images
                                  </p>
                                )}
                              </div>
                            </div>
                        ...
                        <div className="flex items-center space-x-4 text-xs text-slate-500 mt-4">
                          ...
                          <div className="flex items-center space-x-1">
                            <span>👍 {question.likesCount} likes</span>
                          </div>
                        </div>
                      </div>
                    </div>
            ...
            <Card>
              <CardContent className="p-12 text-center">
                ...
                <p className="text-slate-600 mb-6">
                  You haven't asked any questions yet. Start learning by asking
                  your first question in the explore section or request a tutor!
                </p>
