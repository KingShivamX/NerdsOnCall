...
const additionalFeatures = [
  ...
  },
  {
    ...
    description: "Intelligent scheduling system that matches your availability",
  },
  {
    icon: Award,
    title: "Certification",
      ...
      <section className="pt-20 pb-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-xl text-slate-600 max-w-3xl mx-auto mb-8 leading-relaxed">
            Discover how NerdsOnCall revolutionizes education with cutting-edge
            technology, expert tutors, and innovative learning tools designed
            for your success.
          </p>
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
              Enhance your learning experience with our additional features and
              tools
            </p>
          </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
              From elementary concepts to advanced university courses, we've got
              you covered
            </p>
          </div>
            ...
            {subjects.map((subject, index) => (
              ...
              >
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-slate-600 text-sm">{subject.courses}</p>
                </CardContent>
              </Card>
            ))}
          </div>
      ...
      <section className="py-20 bg-slate-800">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-slate-300 mb-8 max-w-2xl mx-auto">
            ...
            personalized, on-demand tutoring with NerdsOnCall.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/auth/register?role=student">
              <Button
